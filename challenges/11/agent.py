...
2. Carefully analyze all constraints, polynomials, or mathematical properties.
...
def run(query: str, assets: list[str] | None = None) -> str:
    ...
    response = client.chat.completions.create(
        # The user requested 'groq/compound' specifically for this challenge
